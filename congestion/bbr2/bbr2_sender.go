...
// NewBBR2SenderWithParams creates a new BBR2 sender with custom parameters.
// This allows fine-tuning BBRv2 for specific network conditions such as ISP QoS.
func NewBBR2SenderWithParams(
	clock Clock,
	maxDatagramSize congestion.ByteCount,
	initialCongestionWindow congestion.ByteCount,
	aggressive bool,
